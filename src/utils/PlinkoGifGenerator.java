...
public class PlinkoGifGenerator {
    ...
    private static final String[] MULTIPLIERS = {"33x", "11x", "4x", "2x", "1.1x", "0.6x", "0.3x", "0.6x", "1.1x", "2x", "4x", "11x", "33x"};

    public static String playAndGenerateGif() {
        int ballX = WIDTH / 2;
        int ballY = 50;
        int steps = ROWS;
        ...
        String finalMultiplier = MULTIPLIERS[finalSlot - 1];
    ...
    private static BufferedImage generatePlinkoImage(int ballX, int ballY, int currentStep) {
        ...
        for (int i = 0; i < COLUMNS - 2; i++) {
            ...
            g.drawString(MULTIPLIERS[i], x + SLOT_WIDTH / 4, y);
        }
        ...
        if (currentStep == ROWS - 1) {
            ...
            g.drawString(finalMultiplier, WIDTH / 2 - 50, HEIGHT / 2);
        }
    ...
    private static byte[] createGif(List<BufferedImage> frames, String finalMultiplier) {
        try {
    ...
    public static void main(String[] args) {
        String finalMultiplier = PlinkoGifGenerator.playAndGenerateGif();
